...
export default async function LearnPage() {
  // A URL não é mais necessária! Os dados agora vêm voando do nosso cache local (JSON)
  ...
  return (
    <div className="bg-black min-h-screen w-full flex flex-col font-sans">
      ...
      <main className="flex-1 w-full max-w-[1536px] mx-auto px-4 md:px-8 pt-32 pb-20 text-white relative z-10">
        ...
        <Suspense fallback={<div className="w-full text-center py-20 text-brand animate-pulse font-mono tracking-widest">CARREGANDO DADOS...</div>}>
